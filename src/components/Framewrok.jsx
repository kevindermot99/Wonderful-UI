...
function Framewrok({logo, title, desc, url}) {
  return (
    <a href={url} target="_blank" className="hover:bg-stone-100 cursor-pointer h-fit flex max-sm:flex-col items-start justify-start gap-4 p-5 rounded-2xl">
